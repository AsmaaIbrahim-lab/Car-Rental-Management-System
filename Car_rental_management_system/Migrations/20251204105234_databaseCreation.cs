    ...
    public partial class databaseCreation : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_carOwners", x => x.CarOwnerId);
                    table.ForeignKey(
                        name: "FK_carOwners_AspNetUsers_CarOwnerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Car_Image", x => new { x.CarId, x.ImagePath });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PickupStartDate = table.Column<DateOnly>(type: "date", nullable: false),
                    PickupStartTime = table.Column<TimeOnly>(type: "time", nullable: false),
                    PickupEndDate = table.Column<DateOnly>(type: "date", nullable: false),
                    PickupEndTime = table.Column<TimeOnly>(type: "time", nullable: false),
                    Final_amount = table.Column<double>(type: "float", nullable: false),
